...
const tiers = [
  {
    ...
    href: "#",
    priceMonthly: "₪99",
    description: "For businesses that want to streamline their calendar and appointment scheduling process",
    features: [
      "Unlimit Schedule appointments",
      "Unlimited Customers",
      "300 Monthly messages",
      "Digital Calendar",
      "Online Scheduling",
      "SMS Confirmation",
      "Statistics N Reports",
      "Access from computer and mobile app",
      ,
      "Exposure to app to search business",
    ],
    featured: false,
  },
  {
    ...
    href: "#",
    priceMonthly: "₪139",
    description: "Bigger messages capacity and tools for increase of income",
    features: [
      "Unlimit Schedule appointments",
      "Unlimited Customers",
      "300 Monthly messages",
  ...
  },
  {
    ...
    href: "#",
    priceMonthly: "₪169",
    description: "The most simple to take our invoices out from the calendar",
    features: [
      "Unlimit Schedule appointments",
      "Unlimited Customers",
      "300 Monthly messages",
